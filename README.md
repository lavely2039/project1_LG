...
- 다시 웹 디자이너로 취업을 준비하면서 내가 가지고 있는 디자인 전공자라는 자부심을 가지고
  디자인 보는 눈과 감각을 키우는데 목적을 두면서, 프런트엔드 개발자와의 원활한 소통을 위해
  CSS 미디어 쿼리를 사용해 반응형 웹이 어떻게 구현되는지 개발자들이 개발할 수 있는 영역이 어디까지인지
  화면 크기에 맞춰 내가 어떻게 디자인 해야 되는지를 다음 프로젝트에서 알아가고 싶습니다.
